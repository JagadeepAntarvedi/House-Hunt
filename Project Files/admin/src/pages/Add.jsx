  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='w-full'>
          <p className='mb-2'>House specification</p>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
              <p className='mb-2'>House category</p>
              <select onChange={(e) => setCategory(e.target.value)} className='w-full px-3 py-2'>
                  <option value="Men">House</option>
                  <option value="Women">Apartment</option>
                  <option value="Kids">Hostel</option>
              </select>
            </div>
            ...
            <div>
              ...
              <select onChange={(e) => setSubCategory(e.target.value)} className='w-full px-3 py-2'>
                  <option value="Topwear">3BHK</option>
                  <option value="Bottomwear">2BHK</option>
                  <option value="Winterwear">1BHK</option>
              </select>
            </div>

            <div>
              <p className='mb-2'>Rent Price</p>
              <input onChange={(e) => setPrice(e.target.value)} value={price} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='25,000' />
            </div>

        </div>

        <div>
          <p className='mb-2'>House Sizes</p>
        ...
        <div className='flex gap-2 mt-2'>
          ...
          <label className='cursor-pointer' htmlFor="bestseller">Add to best-rental</label>
        </div>
